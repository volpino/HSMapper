...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Facility.manager'
        db.add_column('core_facility', 'manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Facility'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Facility.manager'
        db.delete_column('core_facility', 'manager_id')
