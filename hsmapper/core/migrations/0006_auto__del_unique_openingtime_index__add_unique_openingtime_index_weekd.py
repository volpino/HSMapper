...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'OpeningTime', fields ['index']
        db.delete_unique('core_openingtime', ['index'])

        # Adding unique constraint on 'OpeningTime', fields ['index', 'weekday', 'facility']
        db.create_unique('core_openingtime', ['index', 'weekday', 'facility_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OpeningTime', fields ['index', 'weekday', 'facility']
        db.delete_unique('core_openingtime', ['index', 'weekday', 'facility_id'])

        # Adding unique constraint on 'OpeningTime', fields ['index']
        db.create_unique('core_openingtime', ['index'])
