...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpeningTime.index'
        db.add_column('core_openingtime', 'index', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OpeningTime.index'
        db.delete_column('core_openingtime', 'index')
