...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_facility', 'manager')


    def backwards(self, orm):
        
        # Adding field 'Facility.manager'
        db.add_column('core_facility', 'manager', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
