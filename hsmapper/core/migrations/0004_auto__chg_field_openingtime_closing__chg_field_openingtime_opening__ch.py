...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OpeningTime.closing'
        db.alter_column('core_openingtime', 'closing', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'OpeningTime.opening'
        db.alter_column('core_openingtime', 'opening', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'SpecialDay.holiday_date'
        db.alter_column('core_specialday', 'holiday_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'SpecialDay.closed'
        db.alter_column('core_specialday', 'closed', self.gf('django.db.models.fields.NullBooleanField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'OpeningTime.closing'
        db.alter_column('core_openingtime', 'closing', self.gf('django.db.models.fields.TimeField')(default=''))

        # Changing field 'OpeningTime.opening'
        db.alter_column('core_openingtime', 'opening', self.gf('django.db.models.fields.TimeField')(default=''))

        # Changing field 'SpecialDay.holiday_date'
        db.alter_column('core_specialday', 'holiday_date', self.gf('django.db.models.fields.DateField')(default=''))

        # Changing field 'SpecialDay.closed'
        db.alter_column('core_specialday', 'closed', self.gf('django.db.models.fields.BooleanField')())
